...
function Navbar() {
  return (
    <div className="hidden sm:block fixed top-0 left-1/2 bg-black z-50 border-[0.5px] text-gray-400 px-8  py-1 mt-4 shadow-lg pointer-events-auto rounded-full h-10 border-green-500 transform -translate-x-1/2">
